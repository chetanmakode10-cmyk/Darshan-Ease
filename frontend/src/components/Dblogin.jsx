        ...
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <Dropdown>
            ...
            <Dropdown.Menu className="bg-gray-700">
              ...
              <Dropdown.Item className="text-gray-300 hover:bg-gray-600" onClick={() => navigate('/login')}>Login as Admin</Dropdown.Item>
          ...
          <div className="container mx-auto px-4 flex flex-wrap items-center">
            ...
            <div className="w-full lg:w-1/2">
              <div className="bg-gray-800 rounded-lg shadow-lg p-8">
                <h2 className="text-2xl font-bold text-center text-orange-500 mb-6">Temple Administrative Login</h2>
