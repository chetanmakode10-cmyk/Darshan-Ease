        ...
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <Dropdown>
            ...
            <Dropdown.Menu className="bg-gray-700">
              ...
              <Dropdown.Item className="text-gray-300 hover:bg-gray-600" onClick={() => navigate('/signup')}>Signup as Admin</Dropdown.Item>
          ...
          <div className="container mx-auto px-4 flex flex-wrap items-center">
            ...
            <div className="w-full lg:w-1/2">
              <div className="bg-gray-800 rounded-lg shadow-lg p-8">
                <h2 className="text-2xl font-bold text-center text-orange-500 mb-6">Temple Administrative Signup</h2>
                <form onSubmit={handlesignup}>
                  ...
                  <div className="mb-4">
                    <label className="block text-gray-400 text-sm font-bold mb-2" htmlFor="tname">
                      Temple Name
                    </label>
                    <div className="flex items-center border border-gray-700 rounded-md bg-gray-700">
                      <input
                  ...
                  <div className="mb-6">
                    <label className="block text-gray-400 text-sm font-bold mb-2" htmlFor="taddress">
                      Temple Address
                    </label>
                    <div className="flex items-center border border-gray-700 rounded-md bg-gray-700">
                      <input
                        ...
                        id="taddress"
                        className="w-full p-2 pl-3 bg-gray-700 text-gray-300"
                        placeholder="Enter your temple address"
                        value={taddress}
